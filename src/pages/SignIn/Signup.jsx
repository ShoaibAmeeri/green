...
<div role="status" className="">
    ...
    <span class="sr-only">Create an account</span>
          ...
          <button
            ...
            type="submit"
            class="text-white w-full text-center justify-center bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5   me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex items-center"
          >
            {
              loading ? (
                <>
